...
class QuizViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    //------------------------ここから下にクイズを書く------------------------//
    quizArray.append(["タロー坂の名前の由来は？", "作った人の名前", "生えてる木の名前", "作った人が適当につけた", 2])
    quizArray.append(["次のうち間違って表記されているものはどれ？", "λ館", "λ12", "Ω館", 2])
    quizArray.append(["次のうち鴨池にあるものは？", "鴨の餌やりば", "カラス撃退用のカカシ", "船の発着所", 3])
    //------------------------ここから上にクイズを書く------------------------//
    quizArray.shuffle()
    choiceQuiz()
  }
